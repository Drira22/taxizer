...
if __name__ == "__main__":
    ...
    topic_name='trial'
    data_path="/home/khalil/p2m/DATA/MTA BUS/Data/MTA-Bus-Time_.2014-08-01.csv"
    
    #kafka_streaming
    kafka_manager = KafkaManager(topic_name,kafka_bootstrap_servers)
    kafka_manager.start(data_path)
    	

        
        
#kafka_bootstrap_servers = os.getenv('KAFKA_BOOTSTRAP_SERVERS', 'localhost:9092')
#topic_name = os.getenv('TOPIC_NAME', 'trial')
#data_path = os.getenv('DATA_PATH', 'data/MTA-Bus-Time_.2014-08-01.csv')
